...
WebUI.setText(findTestObject('Object Repository/Page_Try Testing This/input_First name_fname'), 'Vijee')

WebUI.setText(findTestObject('Object Repository/Page_Try Testing This/input_Last name_lname'), 'Mathews')
